...
private:
	...
	int          getHeight();
	void        DrawBackground();
	void         SaveGame(CPlayer* m_pPlayer, CPlayer* Player1);
	void        LoadGame(CPlayer* m_pPlayer, CPlayer* Player1);
	...
	std::vector<Bullet*>     m_pBulletEnemy;

	_int64 m_BulletTime = timeGetTime();
